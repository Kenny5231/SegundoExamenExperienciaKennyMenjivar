...
CREATE TABLE IF NOT EXISTS tours (
  ...
  CONSTRAINT uq_tour_name UNIQUE (name)
);
...
CREATE INDEX idx_tour_time ON tour_schedules (tour_id, schedule_time);
...
CREATE INDEX idx_res_schedule ON reservations (tour_schedule_id);
